...
# ]
    ...
    for size in xrange(maxSize, 0, -1):
        ...
        print 'startingIndicesForA',startingIndicesForA
        print 'startingIndicesForB',startingIndicesForB
        for i in startingIndicesForA:
            for j in startingIndicesForB:
                print 'a[i:i+size] vs b[j:j+size]'
                print a[i:i+size]
                print b[j:j+size]
    ...
    print 'commonContiguousSublists',commonContiguousSublists
