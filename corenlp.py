...
class StanfordCoreNLP(object):
    ...
    def __init__(self, corenlp_path=None):
        ...
        # if not corenlp_path:
        #     corenlp_path = "../stanford-corenlp-2016/"
        ...
        start_corenlp = "%s -Xmx1800m -cp %s %s" % (java_path, ':'.join(jars), classname)
        if VERBOSE:
...
if __name__ == '__main__':
    ...
    nlp = StanfordCoreNLP(corenlp_path='../stanford-corenlp-2016/')
